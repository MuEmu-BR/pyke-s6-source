...
void NewParty::GetCoordPanelD(int a1, float a2, float a3, float a4, float a5)
{
	...
	if (gInterface.IsWorkZone2(pX + 70.0f, pY + 275.0f, pX + 70.0f + 20.0f, pY + 275.0f + 20.0f))
	{
	...
	if (gInterface.IsWorkZone2(pX + 133, pY + 275, pX + 133 + 20, pY + 275 + 20))
	{
...
void NewParty::MouseControllerPage(int Click)
{
	...
	if (gInterface.IsWorkZone2(pX + 70, pY + 275, pX + 70 + 20, pY + 275 + 20))
	{
		ClickPage = 0;
	}
	else if (gInterface.IsWorkZone2(pX + 133, pY + 275, pX + 133 + 20, pY + 275 + 20))
	{
		ClickPage = 1;
	}
