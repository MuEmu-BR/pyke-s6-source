...
void JewelsBank::Draw()
{
	...
	this->DrawWindow(eJEWELBANK_MAIN, eJEWELBANK_TITLE, eJEWELBANK_FRAME, eJEWELBANK_FOOTER, 14, StartX, StartY, "Jewel Bank System");
	...
	if (gInterface.IsWorkZone(eJEWELBANK_CLOSE))
	{
		...
		// ----
		gInterface.DrawColoredGUI(eVip_CLOSE, gInterface.Data[eJEWELBANK_CLOSE].X, 18, Color);
...
{
	PMSG_JEWELBANK pMsg;
	pMsg.h.set(0xFF, 0x12, sizeof(pMsg));
	pMsg.Result = number;
