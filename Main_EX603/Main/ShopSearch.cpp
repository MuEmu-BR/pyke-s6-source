...
void PersonalShopEx::BindImages()
{
	...
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP1, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP2, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP3, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP4, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP5, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP6, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP7, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP8, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP9, 0x7898, 170, 21, -1, -1);
	gInterface.BindObject(ePT_PERSONAL_SEARCH_PAGEUP10, 0x7898, 170, 21, -1, -1);
}
// ----------------------------------------------------------------------------------------------
...
void PersonalShopEx::Draw()
{
	...
	if( gInterface.IsWorkZone(ePT_PERSONAL_SEARCH_CLOSE) )
	{
		...
		gInterface.DrawToolTip(gInterface.Data[ePT_PERSONAL_SEARCH_CLOSE].X + 5, gInterface.Data[ePT_PERSONAL_SEARCH_CLOSE].Y + 25, gCustomMessage.GetMessage(70));
	}
	// ----

	gInterface.DrawFormat(eGold, ContentX + 10, ContentY + 8, 210, 3, gCustomMessage.GetMessage(71));
	...
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, gCustomMessage.GetMessage(72));

	ListDrawX += 50;
	gInterface.DrawFormat(eGold, ListDrawX, ListDrawY + 20, 100, 1, gCustomMessage.GetMessage(73));
