...
void ExWinQuestSystem::Load()
{
	...
	this->Read(gPath.GetFullPath("Custom\\QuestSystemWindow\\CreationQuestSystem.ini"));
	this->ReadQuest(0, gPath.GetFullPath("Custom\\QuestSystemWindow\\CreationQuestData_1.ini"));
	this->ReadQuest(1, gPath.GetFullPath("Custom\\QuestSystemWindow\\CreationQuestData_2.ini"));
	this->ReadQuest(2, gPath.GetFullPath("Custom\\QuestSystemWindow\\CreationQuestData_3.ini"));
	this->ReadDrop(gPath.GetFullPath("Custom\\QuestSystemWindow\\CreationQuestDrop.ini"));
}
// ----------------------------------------------------------------------------------------------
...
void ExWinQuestSystem::ReadQuest(int a, char* File)
{
	...
	gLog.AddLog(1, "[QuestSystemWindow][ReadQuest] Item loaded from list");
...
void ExWinQuestSystem::ReadDrop(char* File)
{
		...
		gLog.AddLog(1, "[QuestSystemWindow][ReadDrop]Item loaded from list");
...
void ExWinQuestSystem::CG_AcceptQuest(int aIndex, CG_Accept_Done* aRecv)
{
		...
		if (!lpUser->ExWQuestStart[a])
		{
			...
			{
				gLog.AddLog(2, "[QuestSystemWindow] Error CG_AcceptQuest Result");
				return;
			}
...
void ExWinQuestSystem::RewardQuest(int aIndex, int Act)
{
	//LogAdd(LOG_RED,"Start reward");
		...
		{
			gLog.AddLog(2, "[QuestSystemWindow] RewardQuest ERROR");
