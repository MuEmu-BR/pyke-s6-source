...
void cChangeClass::RecvChangeClass(CG_CHANGECLASS_RECV* Data, int aIndex)
{
	...
	{
		if (lpObj->Coin1 < gChangeClass.m_Price[lpObj->AccountLevel])
		{
	...
	{
		if (lpObj->Coin2 < gChangeClass.m_Price[lpObj->AccountLevel])
		{
	...
	{
		if (lpObj->Coin3 < gChangeClass.m_Price[lpObj->AccountLevel])
		{
