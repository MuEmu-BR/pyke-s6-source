...
BYTE ObjBotAlchemist::Alchemy(int aIndex,int BotNum)
{
	...
	{
		gCashShop.GDCashShopSubPointSaveSend(lpObj->Index,0,this->bot[BotNum].PriceCount,0,0,0);
	}
	else if (this->bot[BotNum].PriceType == 2)
	{
		gCashShop.GDCashShopSubPointSaveSend(lpObj->Index,0,0,this->bot[BotNum].PriceCount,0,0);
	}
	else if (this->bot[BotNum].PriceType == 3)
	{
		gCashShop.GDCashShopSubPointSaveSend(lpObj->Index,0,0,0,this->bot[BotNum].PriceCount,0);
	}
